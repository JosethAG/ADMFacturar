...
GO
CREATE TABLE [dbo].[TBL_DOCUMENTO_CP] ADD  CONSTRAINT [DF_TBL_DOCUMENTO_CP_Fecha_Creacion]  DEFAULT (getdate()) FOR [Fecha_Creacion]
GO
CREATE TABLE [dbo].[TBL_DOCUMENTO_CP] ADD  CONSTRAINT [DF_TBL_DOCUMENTO_CP_Fecha_Modificacion]  DEFAULT (getdate()) FOR [Fecha_Modificacion]
GO
CREATE TABLE [dbo].[TBL_INGRESO_MERCADERIA] ADD  CONSTRAINT [DF_TBL_INGRESO_MERCADERIA_Fecha_Creacion]  DEFAULT (getdate()) FOR [Fecha_Creacion]
GO
CREATE TABLE [dbo].[TBL_INGRESO_MERCADERIA] ADD  CONSTRAINT [DF_TBL_INGRESO_MERCADERIA_Fecha_Modificacion]  DEFAULT (getdate()) FOR [Fecha_Modificacion]
GO
CREATE TABLE [dbo].[TBL_INGRESO_MERCADERIA]  WITH NOCHECK ADD  CONSTRAINT [FK_TBL_INGRESO_MERCADERIA_TBL_INV_ARTICULO] FOREIGN KEY([PK_FK_Articulo])
REFERENCES [dbo].[TBL_ARTICULO] ([PK_Articulo])
GO
CREATE TABLE [dbo].[TBL_INGRESO_MERCADERIA] CHECK CONSTRAINT [FK_TBL_INGRESO_MERCADERIA_TBL_INV_ARTICULO]
GO
CREATE TABLE [dbo].[TBL_INGRESO_MERCADERIA]  WITH NOCHECK ADD  CONSTRAINT [FK_TBL_INGRESO_MERCADERIA_TBL_CONDICIONES_PAGO] FOREIGN KEY([FK_CondicionPago])
REFERENCES [dbo].[TBL_CONDICIONES_PAGO] ([PK_Condicion_Pago])
GO
CREATE TABLE [dbo].[TBL_INGRESO_MERCADERIA] CHECK CONSTRAINT [FK_TBL_INGRESO_MERCADERIA_TBL_CONDICIONES_PAGO]
GO
...
CREATE TABLE [dbo].[TBL_SALIDA_MERCADERIA] ADD  CONSTRAINT [DF_TBL_SALIDA_MERCADERIA_Fecha_Creacion]  DEFAULT (getdate()) FOR [Fecha_Creacion]
GO

CREATE TABLE [dbo].[TBL_SALIDA_MERCADERIA] ADD  CONSTRAINT [DF_TBL_SALIDA_MERCADERIA_Fecha_Modificacion]  DEFAULT (getdate()) FOR [Fecha_Modificacion]
GO

CREATE TABLE [dbo].[TBL_SALIDA_MERCADERIA]  WITH NOCHECK ADD  CONSTRAINT [FK_TBL_SALIDA_MERCADERIA_TBL_INV_ARTICULO] FOREIGN KEY([PK_FK_Articulo])
REFERENCES [dbo].[TBL_ARTICULO] ([PK_Articulo])
GO

CREATE TABLE [dbo].[TBL_SALIDA_MERCADERIA] CHECK CONSTRAINT [FK_TBL_SALIDA_MERCADERIA_TBL_INV_ARTICULO]
GO
...
GO
CREATE TABLE [dbo].[TBL_FACTURA] ADD  CONSTRAINT [DF_TBL_FACTURA_Fecha_Creacion]  DEFAULT (getdate()) FOR [Fecha_Creacion]
GO
CREATE TABLE [dbo].[TBL_FACTURA] ADD  CONSTRAINT [DF_TBL_FACTURA_Fecha_Modificacion]  DEFAULT (getdate()) FOR [Fecha_Modificacion]
GO
CREATE TABLE [dbo].[TBL_FACTURA] ADD  DEFAULT ((0)) FOR [TRANSPORTE]
GO
CREATE TABLE [dbo].[TBL_FACTURA_LINEA] ADD  CONSTRAINT [DF_TBL_FACTURA_LINEA_Fecha_Creacion]  DEFAULT (getdate()) FOR [Fecha_Creacion]
GO
CREATE TABLE [dbo].[TBL_FACTURA_LINEA] ADD  CONSTRAINT [DF_TBL_FACTURA_LINEA_Fecha_Modificacion]  DEFAULT (getdate()) FOR [Fecha_Modificacion]
GO
CREATE TABLE [dbo].[TBL_FACTURA_LINEA] ADD  DEFAULT ((0)) FOR [COSTO]
GO
CREATE TABLE [dbo].[TBL_FACTURA_LINEA]  WITH NOCHECK ADD  CONSTRAINT [FK_TBL_FACTURA_LINEA_TBL_FACTURA] FOREIGN KEY([PK_FK_Factura])
REFERENCES [dbo].[TBL_FACTURA] ([PK_Factura])
GO
CREATE TABLE [dbo].[TBL_FACTURA_LINEA] CHECK CONSTRAINT [FK_TBL_FACTURA_LINEA_TBL_FACTURA]
GO
CREATE TABLE [dbo].[TBL_FACTURA_LINEA]  WITH CHECK ADD  CONSTRAINT [FK_TBL_FACTURA_LINEA_TBL_ARTICULO] FOREIGN KEY([FK_Articulo])
REFERENCES [dbo].[TBL_ARTICULO] ([PK_Articulo])
GO
CREATE TABLE [dbo].[TBL_FACTURA_LINEA] CHECK CONSTRAINT [FK_TBL_FACTURA_LINEA_TBL_ARTICULO]
...
CREATE TABLE [dbo].[TBL_DOCUMENTO_CC] ADD  DEFAULT (getdate()) FOR [Fecha_Creacion]
GO
...
CREATE TABLE [dbo].[TBL_ABONOSXC] ADD  DEFAULT (getdate()) FOR [Fecha_Creacion]
GO

CREATE TABLE [dbo].[TBL_ABONOSXC]  WITH CHECK ADD  CONSTRAINT [FK_TBL_ABONOSXC_TBL_DOCUMENTO_CC] FOREIGN KEY([FK_Documento_CC])
REFERENCES [dbo].[TBL_DOCUMENTO_CC] ([PK_Documento_CC])
GO

CREATE TABLE [dbo].[TBL_ABONOSXC] CHECK CONSTRAINT [FK_TBL_ABONOSXC_TBL_DOCUMENTO_CC]
GO
...
CREATE TABLE [dbo].[TBL_ABONOS]  WITH CHECK ADD  CONSTRAINT [FK_TBL_ABONOS_TBL_DOCUMENTO_CP] FOREIGN KEY([FK_Documento])
REFERENCES [dbo].[TBL_DOCUMENTO_CP] ([PK_Documento])
GO

CREATE TABLE [dbo].[TBL_ABONOS] CHECK CONSTRAINT [FK_TBL_ABONOS_TBL_DOCUMENTO_CP]
GO
