...
namespace ADM.API.Controllers
{
	...
	public class DireccionController : ControllerBase
	{
		...
		{
			DataTable Dtable = DBData.List("sp_SeleccionarProvincias");
		...
		{
			DataTable Dtable = DBData.List("sp_SeleccionarCantones");
			string json = JsonConvert.SerializeObject(Dtable);
		...
		{
			DataTable Dtable = DBData.List("sp_SeleccionarDistritos");
			string json = JsonConvert.SerializeObject(Dtable);
